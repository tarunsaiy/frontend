...
const PendingProducts = () => {
  ...
  const fetchPendingProducts = async () => {
    try {
      const { data } = await axios.get("https://backend-7ux5.onrender.com/productstobeapproved", {
  ...
  const approveProduct = async (id, email) => {
    ...
    try {
      ...
      await axios.put(`https://backend-7ux5.onrender.com/approveproduct/${id}`, { email }, {
        headers: { Authorization: token }
      });
  ...
  const rejectProduct = async (id, email) => {
    ...
    try {
      ...
      await axios.put(`https://backend-7ux5.onrender.com/rejectproduct/${id}`, { email }, {
        headers: { Authorization: token }
      });
